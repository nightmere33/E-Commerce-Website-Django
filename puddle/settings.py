...
SECRET_KEY = 'django-insecure-l_-8x=ec7owb#to&*xl0uoh)kje46x=s6k*j16-d*n77ok#ri@'
...
DATABASES = {
    'default': dj_database_url.parse('postgresql://postgres:egznsYvDTqgjGyOaweCSWTwqmGvTtCNW@crossover.proxy.rlwy.net:49553/railway')
}

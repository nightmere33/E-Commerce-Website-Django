...
class CheckoutForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'address': forms.TextInput(attrs={'class': 'w-full p-2 border rounded-lg bg-slate-800 text-gray-100 border-slate-700 focus:outline-none focus:ring-2 focus:ring-teal-400'}),
            'postal_code': forms.TextInput(attrs={'class': 'w-full p-2 border rounded-lg bg-slate-800 text-gray-100 border-slate-700 focus:outline-none focus:ring-2 focus:ring-teal-400'}),
            'city': forms.TextInput(attrs={'class': 'w-full p-2 border rounded-lg bg-slate-800 text-gray-100 border-slate-700 focus:outline-none focus:ring-2 focus:ring-teal-400'}),
        }